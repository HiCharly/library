...
<div class="space-y-6">
    <div class="flex flex-col gap-2">
        ...
        <div class="h-[300px] w-[200px] rounded-lg overflow-hidden">
            ...
            @else
                <div class="relative size-full bg-neutral-100 rounded-lg flex items-center justify-center cursor-pointer text-neutral-400 hover:text-neutral-600 hover:bg-neutral-200" x-on:click="$refs.coverInput.click()">
                    ...
                    @else
                        <flux:icon.camera class="size-10" wire:loading.remove wire:target="upload" />
                        <flux:icon.loading class="size-10" wire:loading wire:target="upload" />
                    @endif
                    <input
                        x-ref="coverInput"
                        type="file"
